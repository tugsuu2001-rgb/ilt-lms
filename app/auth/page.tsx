        ...
        <div className="w-full max-w-sm">
          ...
          {tab === 'register' && (
            <div className="mb-4">
              ...
              <input className="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:border-[#1d9e75]" placeholder="Таны нэр"/>
            </div>
          )}
          <div className="mb-4">
            <label className="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-2">И-мэйл</label>
            <input type="email" className="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:border-[#1d9e75]" placeholder="name@example.com"/>
          </div>
          <div className="mb-2">
            <label className="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-2">Нууц үг</label>
            <input type="password" className="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:border-[#1d9e75]" placeholder="••••••••"/>
          </div>
          {tab === 'login' && (
          ...
          <button className="w-full bg-[#0f1a2e] text-white rounded-lg py-3 text-sm font-medium hover:bg-[#1d9e75] transition mt-3 mb-4">
